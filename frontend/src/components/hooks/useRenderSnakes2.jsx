...
import createScalesPattern
  from "../../canvas/drawings/snakeDesigns/patterns/createScalesPattern4.js";

const useRenderSnakes2 = (playerSnakeId, otherSnakes) => {
...
export default useRenderSnakes2;
